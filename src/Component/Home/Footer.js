      ...
      <div className="footercontainer">
        <div className="divcontainer1">
          <div>
            ...
            <h4>
              Trusted by more than 1 Crore Indians Cash on Delivery <br></br>|
              Free Delivery
            </h4>
          </div>
        </div>
        ...
        <div className="divcontainer">
          ...
          <h3>facebook.com/Meesho</h3>
          <h3>instagram.com/Meesho</h3>
          <h3>youtube.com/Meesho</h3>
          <h3>connect@Meesho.com</h3>
        </div>
        <div className="divcontainer">
