    ...
    <div className="wishlistcontainer">
      <div className="wishlistsubcontainer">
        <div className="profilesection">
          <div className="myprofilebox">
            <div>
              ...
              <span className="usericonspan">
                <FontAwesomeIcon
                  icon={faUser}
                  className="userprofileiconsection"
                />
              </span>
            </div>
          ...
          <div className="myorderbox">
            <div className="ordersectonbox">
              <span className="bagiconcontainer">
        ...
        <div className="wishlistconstianer">
          <div className="mywishlistheading">
            My Wishlist({wishlstpd && wishlstpd.length})
          </div>
          {wishlstpd && wishlstpd.length > 0 && wishlstpd !== undefined ? (
            wishlstpd.map((item, index) => (
              <div className="prodcontaienr">
                <div className="prdimageprice">
                  <div className="prdimgcontainer">
                    <Link to={`/pdetails/${item.id}`}>
                      <img src={item.image} alt="Product Image" />
                    </Link>
                  </div>
                  <div className="pdtitleprice">
                    <span className="wishlistpdtitle" key={item.id}>
                      {item.title}
                    </span>
                ...
                <div className="removewishitem">
                  <span onClick={(event) => removItemFn(index)}>
