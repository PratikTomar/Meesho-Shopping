                ...
                <div className="productlistSubcontainer">
                  <div className="filtercontainer">
                    ...
                    <div className="Categorycontainer">
                      ...
                      <div>
                        <div className="cateogrycontcainer">
                          <span>Category</span>
                        </div>
                        <div className="categoryitems">
                          <div onClick={() => filterprd("men's clothing")}>
                            men's clothing
                          </div>
                          <div onClick={() => filterprd("women's clothing")}>
                            women's clothing
                          </div>
                          <div onClick={() => filterprd("jewelery")}>
                            jewelery
                          </div>
                          <div onClick={() => filterprd("electronics")}>
                            electronics
                          </div>
                        </div>
                      </div>
                        ...
                        <Link to={`/pdetails/${item.id}`}>
                          <div className="imgContainer">
                            <img
                              ...
                              className="pdp_image_link"
                              style={{ cursor: "pointer" }}
                            />
                          </div>
                        </Link>
                        <div className="pdTitleContainer">
